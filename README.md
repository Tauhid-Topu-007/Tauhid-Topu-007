...
<table align="center" width="100%">
  <tr>
    <td width="50%" valign="top">
      ...
      <ul>
        <li>💻 <strong>Current Focus:</strong> Building MERN Stack Applications</li>
        <li>🌱 <strong>Deep Dive:</strong> Machine Learning & AI</li>
        <li>🤝 <strong>Looking for help with:</strong> DevOps & Cloud Architecture</li>
        <li>💬 <strong>Ask me about:</strong> React, Node.js, MongoDB, Python</li>
        <li>📫 <strong>Reach me:</strong> t.topu021@gmail.com</li>
        <li>⚡ <strong>Fun Fact:</strong> I debug with coffee ☕ and music 🎧</li>
      </ul>
    </td>
    <td width="50%" valign="top">
      <h2 align="center">🚀 Quick Stats</h2>
      <ul>
        <li>📅 <strong>Coding since:</strong> 2020</li>
